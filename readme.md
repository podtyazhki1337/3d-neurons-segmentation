...
This code, weights and dataset accompanies the manuscript: "A large-scale multi-species resource reveals cross-species generalization in label-free 3D neuron segmentation."
